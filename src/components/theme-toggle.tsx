...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- one-shot mount flag: the theme is unknown during SSR, so we render a stable placeholder until mounted to avoid a hydration mismatch (standard next-themes pattern)
    setMounted(true);
  }, []);
