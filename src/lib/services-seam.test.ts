 ...
 *
 * NOTE: Model Registry, Datasets, and Compute have graduated to real-only (seed =
 * the cached real list or [], fetch pulls real data with no mock fallback) so
 * they're intentionally NOT in this mock-seam contract.
 */
const seeds = [
